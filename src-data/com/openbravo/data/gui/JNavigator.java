...
public class JNavigator extends javax.swing.JPanel implements BrowseListener, StateListener {
    ...
    public JNavigator(BrowsableEditableData bd, Vectorer vec, ComparatorCreator cc, int iButtons) {
        ...
        if (iButtons == BUTTONS_ALL) {
            ...
            jbtnFirst.setMargin(new java.awt.Insets(7, 28, 7, 28));            
        ...
        if (iButtons == BUTTONS_ALL) {
            ...
            jbtnPrev.setMargin(new java.awt.Insets(7, 28, 7, 28));
        ...
        jbtnRefresh.setMargin(new java.awt.Insets(7, 28, 7, 28));
        ...
        if (iButtons == BUTTONS_ALL) {
            ...
            jbtnNext.setMargin(new java.awt.Insets(7, 28, 7, 28));
        ...
        if (iButtons == BUTTONS_ALL) {
            ...
            jbtnLast.setMargin(new java.awt.Insets(7, 28, 7, 28));
        ...
        if (bd.canLoadData()) {
            ...
            jbtnReload.setMargin(new java.awt.Insets(7, 28, 7, 28));
        ...
        if (vec == null) {
            ...
            jbtnFind.setMargin(new java.awt.Insets(7, 28, 7, 28));
        ...
        if (m_cc != null) {
            ...
            jbtnSort.setMargin(new java.awt.Insets(7, 28, 7, 28));
