...
public class ProductsEditor extends JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        add(m_jRef);
        m_jRef.setBounds(90, 50, 130, 20);
        add(m_jName);
        m_jName.setBounds(300, 50, 328, 20);
        ...
        m_jImage.setBounds(340, 20, 270, 230);
        ...
        add(jTabbedPane1);
        jTabbedPane1.setBounds(10, 90, 623, 290);
